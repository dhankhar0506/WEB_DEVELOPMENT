...
It tells the browser where to send the HTTP request.
...
-> Nginx receives requests and forwards them to Node.js.

## 2. SSL / HTTPS

-> Nginx handles SSL (Secure Socket Layer) certificates and HTTPS encryption.
...
-> Nginx can act as an additional security layer in front of backend applications.
...
❌ Nginx does not automatically create multiple servers.
