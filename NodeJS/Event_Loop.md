...
Remember:
    ...
    1. Timers Runs callbacks of:  setTimeout() and setInterval()
        ↓
    2. Pending Callbacks
        ↓
    3. Idle / Prepare -> An internal phase used by libuv to prepare for the next phase.
        ↓
    4. Poll ⭐ -> Handles completed I/O operations like: File read |  Database response |  HTTP request |  Network events
        ↓
    5. Check
        ↓
    6. Close Callbacks -> Runs callbacks when resources like sockets or streams are closed.
